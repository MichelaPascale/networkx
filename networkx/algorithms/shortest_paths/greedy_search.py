...
def main():
    ...
    g = nx.Graph()
    g.add_nodes_from([('A', {'position':366}),
        ('Z', {'position':374}),
        ('O', {'position':380}),
        ('T', {'position':329}),
        ('L', {'position':244}),
    ...
    #Funzione distanza tra due nodi
    def dist(a, b):
    ...
    #Prova su astar
    astar_path = nx.astar_path(g, 'A', 'B', heuristic=None, weight='weight')
    print(astar_path)
    #Prova su greedy
    greedysearch_path = greedy_path(g, 'A', 'B', heuristic=None, weight='weight')
    print(greedysearch_path)

#Per invocare il main
...
astar_path: ['A', 'S', 'R', 'P', 'B']
greedy_path: ['A', 'S', 'F', 'B'] -> Ok
